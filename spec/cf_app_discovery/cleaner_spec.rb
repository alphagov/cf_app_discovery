...
RSpec.describe CfAppDiscovery::Cleaner do
  ...
  let(:current_target) do
    CfAppDiscovery::Parser::Target.new(guid: guid, name: "foo", instances: 1, state: "", env: {}, route: "", space: "", org: "")
  end
  let(:stopped_target) do
    CfAppDiscovery::Parser::Target.new(guid: old_guid, name: "foo", instances: 1, state: "", env: {}, route: "", space: "", org: "")
  end
